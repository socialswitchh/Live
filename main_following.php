                        ...
                        ?> 
                            <div class="column is-3">
                                <a class="friend-item has-text-centered">
                                    ...
                                    <h3><?php echo $row_following['fname'].' '.$row_following['lname'];?></h3>
                                    <p><button type="button" class="cancle_request_follow" to-id="<?php echo $row_following['id']; ?>" style="color:#ed7239;">Following</button></p>
                                </a>
                            </div>
                        <?php } ?>     
                        </div>
