    ...
    <div class="signup-wrapper">
        ...
        <div class="outer-panel">
            <div class="outer-panel-inner">
                ...
                <div id="signup-panel-1" class="process-panel-wrap is-active step1">
					<form method="post" action="ajax/signup.php" name="registration">
						<div class="form-panel">
							...
							<div class="field">
								...
								<div class="control">
									<input type="number" class="input" name="mobile" id="mobile" placeholder="Enter mobile">
								</div>
							</div>
							<div class="field">
								<!-- <label>Unique Name</label> -->
								<div class="control">
									<input type="text" class="input" name="unique_name" id="unique_name" placeholder="Unique Name">
								</div>
							</div>
							<div class="field">
								<!-- <label>Email</label> -->
							...
							<div class="field">
								<!-- <label>Password</label> -->
								<div class="control">
									<input type="text" class="input" name="password" placeholder="Your password">
								</div>
							</div> 
						</div>
						...
						<!--	<a class="button process-button" data-step="step-dot-1">Back</a>-->
							<!--<a class="button process-button" data-step="step-dot-3">
								<button type="submit" class="button  registration" id="signup">Next</button>
							</a>-->
							 <button type="submit" class="button  registration" data-step="step-dot-3" id="signup">Next</button> 
						</div>
					</form>
                </div> 
        </div>
	...
	<script>
		$(document).ready(function() { 
			...
			$('#first_name').on('blur',function(){
				  ...
				  var unq_name = '@'+fname+rand_num;
				  $.ajax({ 
						url: "ajax/check_unique_name.php",
						type:"POST",
						data:'unq_name='+unq_name,
						dataType: "json", 
						success: function(data){ 
							console.log(data);
							$("#unique_name").val(data.unq_name); 
						}
					}); 
			}); 
                    ...
                    $(function() {
                        $("form[name='registration']").validate({
                            ...
                            messages: {
								...
								unique_name: {
                                    required: "Please enter your unique name.",
                                    remote: "Unique name alredy exist"
                                },
                                email: {
                            ...
                            submitHandler: function(form) { 
                                $.ajax({
                                    ...
                                    success: function(response) {
										...
										window.setTimeout(function(){location.assign("signup_step2.php")}, 2000); 
                                    } 
                                });
                            }
                        });
