...
$sql_cover_photo = "SELECT * FROM users_cover_photo WHERE user_id = '" . $dummy_row['id'] . "' AND type='main' ORDER BY id DESC LIMIT 1";
        ...
        <div id="profile-main" class="view-wrap is-headless">
                ...
                <div class="column is-paddingless">
                    ...
                    <div class="profile-menu is-hidden-mobile">
                        ...
                        <div class="menu-end">
                            ...
                            <?php
                            $sql1 = "SELECT * FROM gt_friend_request WHERE request_to_id = '" . $row["id"] . "' and request_from_id='" . $dummy_row["id"] . "'";
                            // echo $sql1;
                            ...
                            <a href="#" class="button has-min-width">Message</a>
                        </div>
                    </div>

                    <div class="profile-subheader">
                        <div class="subheader-start flex-center-gap-left ">
                        ...
                        <div class="subheader-end subheader-start flex-center-gap-right">
            ...
            <div class="columns">
                <div id="profile-timeline-widgets" class="column is-4">
                    ...
                    <div class="box-heading">
                        ...
                        <div class="menu-end">
                            ...
                            <?php if ($num_row == 0) { ?>
                                <a href="#" class="button has-min-width sending_follow_request" data-toggle="modal" data-userid="<?php echo $row["id"] ?>" data-privacy="<?php echo $row["is_privacy"]; ?>" data-from="<?php echo $dummy_row['id']; ?>" data-fullname="<?php echo $dummy_row['fname'] . ' ' . $dummy_row['lname']; ?>" data-photo="<?php echo $dummy_row['photo']; ?>">Follow   </a>
                            ...
                            <?php } else { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } else { ?>
                                        <a href="#" class="button has-min-width sending_follow_request" data-toggle="modal" data-userid="<?php echo $row["id"] ?>" data-privacy="<?php echo $row["is_privacy"]; ?>" data-from="<?php echo $dummy_row['id']; ?>" data-fullname="<?php echo $dummy_row['fname'] . ' ' . $dummy_row['lname']; ?>" data-photo="<?php echo $dummy_row['photo']; ?>">
                                            Follow
                ...
                <div class="column is-8">
                    ...
                    $query = @mysqli_query($conn, "SELECT * FROM gt_posts WHERE user_id ='" . $_GET['id'] . "' AND  is_post='dummy'  ORDER BY id DESC");
                                        ...
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                <div style="display: flex;">
                                                    <a href="main_user_profile.php?id=<?php echo $row_user_query['id']; ?>" class="d-flex-star" style="display: flex;">
                                                            ...
                                                            <span class="span-title d-flex-star">
                                                                <span class="rating_star-m">
                                                                    <span class="star-textm" style="font-size: 14px !important;">
                                                                         <?php echo getProfileRating($conn,  $postData['user_id']);?>/5
                                                                        <label class="star-checked">★</label>
                                                                    </span>
                                                                </span>
                                                            </span>                                                                                          
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.show_cover_photo').click(function() {
             ...
             $('.cancle_request_follow').click(function() {
                ...
                if (strconfirm == true) {
                    ...
                    var from_id = '<?php echo $dummy_row['id'] ?>';
                    $.ajax({
            ...
            $('.friend_request_accept').click(function() {
                ...
                var fullname = '<?php echo $dummy_row['fname'] . ' ' . $dummy_row['lname']; ?>';
                $.ajax({
            ...
            $('.sending_follow_request').click(function() {
                ...
                $.ajax({
                    url: 'ajax/send_follow_request_dummy.php',
                    type: 'POST',
                    data: {
                        to_id: to_id,
                        from_id: from_id,
