...
if (empty($_SESSION['is_login'])) {
    header("Location: https://app.switchh.in/");
}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                                                    <div class="custom-carousel hidescrollbar">
                                                                        <?php 
                                                                        $sql = "SELECT * FROM gt_users WHERE id NOT IN('" . $dummy_row['id'] . "') and anonymous IN (" . $dummy_row['anonymous'] . ") ORDER BY FIELD(anonymous, " . $dummy_row['anonymous'] . ") ASC";
                                                                        $result = $conn->query($sql);
                                                                        $num_row = @mysqli_num_rows($result);
                                                                        if ($num_row > 0) {
                                                                            while ($row = $result->fetch_assoc()) {
                                                                                $sql1 = "SELECT * FROM gt_friend_request WHERE request_to_id = '" . $dummy_row['id'] . "' and request_from_id ='" . $row["id"] . "'";
                                                                                echo $sql1;
                                                                                $result1 = mysqli_query($conn, $sql1) or die("Error:" . mysqli_error($conn));
                                                                                $row1 = mysqli_fetch_assoc($result1);
                                                                                //echo $row['id'].'='.$row1['request_from_id'];
                                                                                if ($row["id"] != $row1['request_from_id']) {
                                                                        ?>
                                                                                <div class="item">
                                                                                    <div class="pad15">
                                                                                        ...
                                                                                        <div class="add-friend add-transition sending_follow_request" data-userid="<?php echo $row['id']; ?>" data-from="<?php echo $dummy_row['id']; ?>" data-fullname="<?php echo $dummy_row['fname'];?>">
                                                                                            Follow
                                                                                        </div>
                                                                    ...
                                                                    <div class="custom-carousel hidescrollbar">
                                                                       ...
                                                                       // echo $suggestions_ids;
                                                                        ...
                                                                        if ($num_row > 0) {
                                                                         ...
                                                                         /*$sql = "SELECT gt_users.id as userid, gt_users.fname, gt_users.lname, gt_users.photo, gt_users.is_login, gt_friend_request.request_from_id, gt_friend_request.request_to_id 
                                                                          FROM gt_friend_request
                                                                          INNER JOIN gt_users ON gt_friend_request.request_from_id=gt_users.id WHERE request_to_id='".$_SESSION['id']."'";
                                                                          // echo $sql;
                                                                          $result = $conn->query($sql);
                                                                          $num_row = @mysqli_num_rows($result);
                                                                          if ($num_row>0) {
                                        ...
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                <div style="display: flex;">
                                                    ...
                                                    <a href="main_profile.php"><?php echo $row_user_query['fname'] . ' ' . $row_user_query['lname']; ?></a>
                                                    <?php } else { ?>
                                            ...
                                            if ($postData['user_id'] == $_SESSION['id'] || $postData['user_id'] == $dummy_row['id']) {  ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <div class="rating_box" uk-toggle="target: #create-post-modal_rating">
                                                        ...
                                                        <h3 class="average_rating_hide"><?php if ($postData['average_rating'] != "") {
                                        ...
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                <div style="display: flex;">
                                                    ...
                                                    <a href="dummy_profile.php"><?php echo $row_user_query['fname']. ' ' . number_format((float)$profile_ratig, 1, '.', ''); ?>/5</a>
                                                    
                                                    <?php } else { ?>
                                                     <a href="dummy_user_profile.php?user_id=<?php echo $row_user_query['id']; ?>"><?php echo $row_user_query['fname']; ?>
                                                        <?php if (!empty($row_user_query['profile_rating'])) {
                                                                        echo $row_user_query['profile_rating'];
                                                                    } else {
                                                                        echo 0;
                                                                    } ?>/5
                                                                 </a>
                                            ...
                                            <div class="media post-comment has-emojis">
                                                <form method="POST" class="commentForm">
                                                    <div class="media-content">
                                                        <div class="field">
                                                            <p class="control">
                                                                <input type="text" class="textarea comment-textarea commentt" name="comment" rows="5" placeholder="Write a comment..." value="" autofocus>
                                                            </p>
                                                            <input type="hidden" name="postId" class="postId" value="<?php echo $post_id; ?>" />
                                                        ...
                                                        <div class="actions">
                                                            ...
                                                            <div class="toolbar">
                                                                ...
                                                                <button type="button" class="button is-solid primary-button raised">Post Comment</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
