                            ...
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-3">
                                    <a class="friend-item has-text-centered">
                                        ...
                                        <h3><?php echo $row_followers['fname'].' '.$row_followers['lname'];?></h3>
                                        <!-- <p>From Rome</p> -->
                                        <?php if($row_followers['request_type']!='following'){ ?> 
    
                                            <a href="#" style="color:#ed7239;" class="send_follow_request" follow_request_to-id="<?php echo $row_followers['id'];?>" follow_request_from-id="<?php echo $_SESSION['id']; ?>" follow_request_fullname="<?php echo $row_followers['fname'].' '.$row_followers['lname'];?>">Follow</a>&nbsp;&nbsp;&nbsp;  
                                        <?php } ?>  
                                            <a href="#" style="color:#ed7239;" class="remove_follower" remove_request_to-id="<?php echo $row_followers['id'];?>" remove_request_from-id="<?php echo $_SESSION['id']; ?>">Remove</a> 
                                </div>
                                <?php } ?>
                                <!--Friend item-->
