                ...
                <div class="columns">
                        ...
                        <div class="box-heading">
                            <div class="dropdown friends-dropdown is-spaced is-neutral dropdown-trigger">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <div> 
                                         <h1 class="follow-head">Following</h1> 
                                    </div>
                    ...
                    <div class="friends-grid">
                        <div class="columns is-multiline">
                            <!--Friend item-->
                        <?php 
                            while ($row_following = mysqli_fetch_assoc($query_retrived_following)) {  
                        ?> 
                            <div class="column is-3">
                                <a class="friend-item has-text-centered" href="dummy_profile.php?id=<?php echo $row_following['id'];?>">
                                    <div class="avatar-wrap">
                                        <div class="circle"></div>
                                        <div class="chat-button">
                                            <i data-feather="message-circle"></i>
                                        </div>
                                        <?php if(!empty($row_following['photo'])){?>
                                            <img src="<?php echo $row_following['photo'];?>" data-demo-src="<?php echo $row_following['photo'];?>" data-user-popover="7" alt="">
                                        <?php } else { ?>
                                             <img src="./upload/user/male.jpeg" alt="">
                                        <?php }  ?> 
                                    </div>
                                    <h3><?php echo $row_following['fname'];?></h3>
                                    <p><button type="button" class="cancle_request_follow blue-btn" style="margin-top: 5px;margin-top: 5px;border: 0;height: 24px;line-height: 20px;" to-id="<?php echo $row_following['id']; ?>" style="color:#ed7239;">Following</button></p>
                                </a>
                            </div>
                        <?php } ?>     
                        </div>
