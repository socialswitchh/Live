            ...
            <div class="outer-panel-inner">
                ...
                <div id="signup-panel-4" class="process-panel-wrap is-narrow  is-active step3"> 
                    ...
                    <div class="form-panel alloptions"> 
                        <form method="post" action="ajax/change_anonymous.php" name="anonymous" style="display:flex; justify-content: flex-start;flex-wrap: wrap;">
                            ...
                            while ($row = $query->fetch_assoc()) { ?>
                                <div class="dropdown is-hoverable mr-4" style="padding-bottom:10px;">
                    ...
                    <div class="buttons">
                        <a class="button process-button" href="dummy_profile.php">Back</a>
                        <button type="submit" class="button process-button click_an" data-step="step-dot-5">Next</button>
                    </div>
                    </form>
                </div>
            </div>
