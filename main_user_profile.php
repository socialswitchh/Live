...
$sql = "SELECT * FROM gt_users WHERE id = '" . $_GET['id'] . "'";
...
$sql_followers = "SELECT usr.id, usr.fname, usr.lname, usr.photo, usr.gender, usr.dummy_id, fr.request_to_id, fr.request_status FROM gt_friend_request as fr INNER JOIN gt_users as usr ON usr.id = fr.request_from_id WHERE request_to_id = '" . @$row['id'] . "'";
$query_retrived_followers = mysqli_query($conn, $sql_followers) or die("Error:" . mysqli_error($conn));

$sql_following = "SELECT usr.id, usr.fname, usr.lname, usr.photo, usr.gender, usr.dummy_id, fr.request_from_id, fr.request_status FROM gt_friend_request as fr INNER JOIN gt_users as usr ON usr.id = fr.request_to_id WHERE request_from_id = '" . @$row['id'] . "'";
$query_retrived_following = mysqli_query($conn, $sql_following) or die("Error:" . mysqli_error($conn));

$sql_photo = "SELECT * FROM users_photo WHERE user_id = '" . $_GET['user_id'] . "' AND type='main' ORDER BY id DESC LIMIT 1";
...
$sql_cover_photo = "SELECT * FROM users_cover_photo WHERE user_id = '" . $_GET['user_id'] . "' AND type='main' ORDER BY id DESC LIMIT 1";
        ...
        <div id="profile-main" class="view-wrap is-headless">
            <div class="columns is-multiline no-margin">
                ...
                <div class="column is-paddingless">
                    ...
                    <div class="profile-menu is-hidden-mobile">
                        ...
                        <div class="menu-end">
                            <input type="hidden" class="userId" value="<?php echo $_GET['user_id']; ?>">
                            <input type="hidden" class="requestToId" value="<?php echo $_GET['request_to_id']; ?>">
                            <?php
                            $sql1 = "SELECT * FROM gt_friend_request WHERE request_from_id = '" . $_SESSION['id'] . "' and request_to_id='" . $row["id"] . "'";
                            // echo $sql1;
                            ...
                            $sql_accept = "SELECT * FROM gt_friend_request WHERE request_to_id='" . @$_GET["request_to_id"] . "' AND request_from_id = '" . $_GET['user_id'] . "'";
                            $result_accept = mysqli_query($conn, $sql_accept) or die("Error:" . mysqli_error($conn));
                            $row_accept = mysqli_fetch_assoc($result_accept);
                            $num_row_accept = mysqli_num_rows($result_accept);
                            ?> 
                            
                            <a href="profile-photos.html" class="button has-min-width">Message</a>
                        </div>
                    </div>
                    ...
                    <div class="profile-subheader">
                        <div class="subheader-start">
                            ...
                            <span><a href="main_following.php?id=<?php echo $row['id'];?>">Following</a></span>
                        </div>
                        ...
                        <div class="subheader-end subheader-start">
                            ...
                            <span><a href="main_followers.php?id=<?php echo $row['id'];?>">Followers</a></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="columns">
                <div id="profile-timeline-widgets" class="column is-4">
                    ...
                    <div class="box-heading">
                        ...
                        <div class="menu-end">
                            ...
                            <?php if ($num_row == 0) { ?>
                                <a href="#" class="button has-min-width sending_follow_request" data-toggle="modal" data-userid="<?php echo $row["id"] ?>" data-privacy="<?php echo $row["is_privacy"]; ?>" data-from="<?php echo $_SESSION['id']; ?>" data-fullname="<?php echo $_SESSION['fname'] . ' ' . $_SESSION['lname']; ?>" data-photo="<?php echo $main_row['photo']; ?>">Follow</a>
                                <!--  <a href="#block_remove" class="rounded-md bg-blue-600 text-white  space-x-1.5" data-toggle="modal" data-userid="<?php echo $row["id"] ?>"><img src="./img/tick.jpeg" height="35" width="35"></a> -->
                            <?php } else { ?>
                                <?php if (@$row1['request_status'] == 'Pending') { ?>
                                    <a href="#" class="button has-min-width ">
                                        Requested
                                    </a>
                                <?php } else { ?>
                                    <?php if (@$row1['request_status'] == 'Accept') { ?>
                                        <a class="button has-min-width cancle_request_follow" data-toggle="modal" id="unfollow" data-userid="<?php echo $row["id"] ?>">
                                            Following 
                                        </a> 
                                    <?php } else { ?>
                                        <a href="#" class="button has-min-width sending_follow_request" data-toggle="modal" data-userid="<?php echo $row["id"] ?>" data-privacy="<?php echo $row["is_privacy"]; ?>" data-from="<?php echo $_SESSION['id']; ?>" data-fullname="<?php echo $_SESSION['fname'] . ' ' . $_SESSION['lname']; ?>" data-photo="<?php echo $main_row['photo']; ?>">
                                            Follow
                            ...
                            <?php } ?>
                            <?php if (@$row_accept['request_status'] == 'Pending') { ?>
                                <a href="#" class="button has-min-width friend_request_accept " data-toggle="modal" data-userid="<?php echo $row["id"] ?>">
                                    <img src="./image/tick.jpeg" height="35" width="35">
                                    <span class="hide_accept"> Accept </span>
                                    <input type="hidden" class="userId" value="<?php echo $row1["request_from_id"] ?>">
                                    <input type="hidden" class="requestToId" value="<?php echo $row1["request_to_id"] ?>">
                                </a>
                            <?php } else if (@$row_accept['request_status'] == 'Accept') { ?>
                                <a href="#block_remove" class="button has-min-width" data-toggle="modal" data-userid="<?php echo $row["id"] ?>"><img src="./image/tick.jpeg" height="35" width="35"></a>
                            <?php } else { ?>
                                <a href="#"></a>
                            <?php } ?>
                ...
                <div class="column is-8">
                    ...
                    <?php
                    $sql_get_followers = mysqli_query($conn, "SELECT request_from_id, request_to_id FROM gt_friend_request WHERE request_from_id='" . $_GET['user_id'] . "' AND request_status='Accept'");

                    while ($row_followers = $sql_get_followers->fetch_assoc()) {

                        $res_followers_id[] = $row_followers['request_to_id'];
                    }
                    $sql_get_followers1 = mysqli_query($conn, "SELECT request_from_id, request_to_id FROM gt_friend_request WHERE request_from_id='" . $_GET['user_id'] . "' AND request_status='Accept'");
                    ...
                    if (@$res_followers_id[0] == "") {
                        ...
                        $allid = $_SESSION['id'] . ',' . $_GET['user_id'];
                    } else {

                        $ids = implode(',', $res_followers_id);

                        $allid = $ids . ',' . $_SESSION['id'] . ',' . $_GET['user_id'];
                    }

                    $i = 1;

                    $query = @mysqli_query($conn, "SELECT * FROM gt_posts WHERE user_id ='" . $_GET['id'] . "' AND  is_post='main'  ORDER BY id DESC");
                    while ($row = $query->fetch_assoc()) {
                        // echo "SELECT * FROM gt_users WHERE id ='" . $row['user_id'] . "'";
                                        ...
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                <div style="display: flex;">
                                                    <a href="main_user_profile.php?user_id=<?php echo $row_user_query['id']; ?>"><?php echo $row_user_query['fname'] . ' ' . $row_user_query['lname']; ?></a>
                                                </div>
                                                <div style="display: flex;">
                ...
                <div id="signup-panel-1" class="process-panel-wrap is-active step1" style="padding: 20px 25px;">
                    ...
                    <div class="form-panel">
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input edit_fname" name="firstname" id="first_name" placeholder="Enter your first name">
                            </div>
                        </div>
                        <div class="field">
                            <!-- <label>Last Name</label> -->
                            <div class="control">
                                <input type="text" class="input edit_lname" name="lastname" placeholder="Enter your last name">
                            </div>
                        </div>
                        <div class="field">
                            <!-- <label>Website</label> -->
                                ...
                                <div class="selection-box modal-trigger">
                                    <div class="box-content">
                                        ...
                                        <div class="box-text">
                                            ...
                                            <input type="file" id="cover_file" name="cover_file" onChange=" return uploadCoverPhoto();">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.cancle_request_follow').click(function() {
                var strconfirm = confirm("Are you sure to Unfollow?");
                if (strconfirm == true) {
            ...
            $('.remove_profile_picture').click(function() {
                ...
                if (strconfirm == true) {
                    $.ajax({
                        url: 'ajax/remove_profile_picture.php',
                        type: 'POST',
                        //data: {header:header, content:content, fileToUpload:fileToUpload},  
                        success: function(response) {
                            window.setTimeout(function() {
                                location.assign("main_profile.php")
                            }, 1000);
                        }
                    });
                }
            ...
            $('.remove_cover_picture').click(function() {
                ...
                if (strconfirm == true) {
                    $.ajax({
                        url: 'ajax/remove_cover_picture.php',
                        type: 'POST',
                        //data: {header:header, content:content, fileToUpload:fileToUpload},  
                        success: function(response) {
                            window.setTimeout(function() {
            ...
            $('.save_profile').click(function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: 'fname=' + fname + '&lname=' + lname + '&bio=' + bio + '&website=' + website,
            ...
            $('.friend_request_accept').click(function() {
                $('.hide_accept').hide();
                var userId = $('.userId').val();
                var requestToId = $('.requestToId').val();
                var fullname = '<?php echo $_SESSION['fname'] . ' ' . $_SESSION['lname'] ?>';
                $.ajax({
                    url: "ajax/friend_request_follow.php",
                    type: "POST",
                    data: {
                        userId: userId,
            ...
            $('.dummy_friend_request_accept').click(function() {
                $('.hide_accept').hide();
                var userId = $('.userId').val();
                var requestToId = $('.requestToId').val();
                $.ajax({
                    url: "ajax/dummy_friend_request_follow.php",
                    type: "POST",
                    data: {
                        userId: userId,
                        requestToId: requestToId
            ...
            $('.sending_follow_request').click(function() {
                ...
                //alert('to_id='+to_id+'&from_id='+from_id+'&fullname='+fullname);
                $.ajax({
                    url: 'ajax/send_follow_request_main.php',
                    type: 'POST',
                    data: {
