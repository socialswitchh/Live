                ...
                <div id="signup-panel-4" class="process-panel-wrap is-narrow  is-active step3">
                    ...
                    <div class="form-panel mb-5"> 
                        <b>Select interest</b> <br>
                            You can select only three interest
                    ...
                    <div class="form-panel alloptions">
                        ...
                        <form method="post" action="ajax/anonymous.php" name="anonymous" style="display:flex; justify-content: flex-start;flex-wrap: wrap;">
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                window.setTimeout(function() {
                                    location.assign("signup_step4.php")
                                }, 2000);
