...
session_start();  
	...
	if($result){ 
			$sql2 = "UPDATE gt_friend_request SET request_type='following' WHERE request_to_id='".$from_id."' AND  request_from_id='".$to_id."'";  
			$conn->query($sql2); 
		//	$sql3 = "UPDATE gt_users SET is_follow='1' WHERE id='".$from_id."'";  
		//	$conn->query($sql3); 
