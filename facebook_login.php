...
*/
	...
	$unique_name = '@'.$firstname.rand(100000,999990);
    ...
    if($count_check==0){
    	$sql = "INSERT INTO gt_users(dummy_id, fname, lname, email, unique_name, password, created_at)VALUES(0,'$firstname','$lastname','$email', '$unique_name', '$password', '$current_date')";  
    	...
    	$sql = "UPDATE gt_users SET login_with='Facebook' WHERE email='".$email."'";  
		$result = $conn->query($sql);
