...
<body>
    ...
    <div class="app-overlay"></div> 
        ...
        <!-- Container -->
        <div class="container is-custom view-wrapper view-wrapper-follow" style="margin-top:60px;">
                ...
                <div class="columns">
                        ...
                        <div class="box-heading">
                            <div class="dropdown friends-dropdown is-spaced is-neutral dropdown-trigger">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <div> 
                                         <h1 class="follow-head">Followers</h1> 
                                    </div>
                    ...
                    <div class="friends-grid">
                        <div class="columns is-multiline">
                            <!--Friend item-->
                            <?php  
                                while ($row_followers = mysqli_fetch_assoc($query_retrived_followers)) {   
                            ?>
                            <div class="column is-3">
                                <div class="friend-item">
                                    <a class=" has-text-centered" href="dummy_profile.php?id=<?php echo $row_followers['id'];?>">
                                        <div class="avatar-wrap">
                                            <div class="circle"></div>
                                            <div class="chat-button">
                                                <i data-feather="message-circle"></i>
                                            </div>
                                            <?php if(!empty($row_followers['photo'])){?>
                                                <img src="<?php echo $row_followers['photo'];?>" data-demo-src="<?php echo $row_followers['photo'];?>" data-user-popover="7" alt="">
                                            <?php } else { ?>  
                                                     <img src="./upload/user/male.jpeg" alt="">
                                           <?php } ?>
                                        </div>
                                        <h3 style="margin-bottom: 8px;"><?php echo $row_followers['fname'];?></h3> 
                                        <div style="text-align:center;">
                                            <?php if($row_followers['request_type']!='following'){ ?> 
        
                                                <a href="#" class="send_follow_request blue-btn" follow_request_to-id="<?php echo $row_followers['id'];?>" follow_request_from-id="<?php echo $_SESSION['id']; ?>" follow_request_fullname="<?php echo $row_followers['fname'].' '.$row_followers['lname'];?>">Follow</a>&nbsp;&nbsp;&nbsp;  
                                            <?php } ?>  
                                                <a href="#" class="remove_follower red-btn" remove_request_to-id="<?php echo $row_followers['id'];?>" remove_request_from-id="<?php echo $_SESSION['id']; ?>">Remove</a> 
                                        </div>
                                    </a>        
                                </div>
                            </div>
