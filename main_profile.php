...
$sql_cover_photo = "SELECT * FROM users_cover_photo WHERE user_id = '" . $main_row['id'] . "' AND type='main' ORDER BY id DESC LIMIT 1";
        ...
        <div id="profile-main" class="view-wrap is-headless">
            ...
            <div class="columns">
                ...
                <div class="column is-8">
                    ...
                    $query = @mysqli_query($conn, "SELECT * FROM gt_posts WHERE user_id ='" . $_SESSION['id'] . "' AND  is_post='main'  ORDER BY id DESC");
                                    ...
                                    <div class="card-heading">
                                        <div class="user-block">
                                            ...
                                            <div class="user-info">
                                                ...
                                                <div style="display: flex;">
                                                    <span class="time has-text-weight-medium"><?php echo $main_row['unique_name']; ?></span>
