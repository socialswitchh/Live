			...
			<form class="form-horizontal form-label-left" id="upload_form" action="dynamic/custom_anonymous.php" method="post" accept-charset="UTF-8" enctype="multipart/form-data" >
			  <div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
				  ...
				  <select class="select2_multiple form-control anonymous_type" id="anonymous_type">
			  ...
			  <div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
				  <input type="text" class="form-control anonymous_name" id="anonymous_name" placeholder="Anonymous Name">
				</div>
			  </div> 
			  ...
			  <div class="form-group">
				<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"> 
				  ...
				  <button type="button" class="btn btn-success anonymous_edit" >Update</button>
				</div>
			  </div> 
			</form>
		  </div> 
